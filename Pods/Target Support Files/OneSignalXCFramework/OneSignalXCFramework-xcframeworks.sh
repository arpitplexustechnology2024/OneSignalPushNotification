...
{
  case "$1" in
  "OneSignal.xcframework/ios-arm64")
    echo ""
    ;;
  "OneSignal.xcframework/ios-arm64_x86_64-maccatalyst")
    echo "maccatalyst"
    ;;
  "OneSignal.xcframework/ios-arm64_x86_64-simulator")
    echo "simulator"
    ;;
...
install_xcframework "${PODS_ROOT}/OneSignalXCFramework/iOS_SDK/OneSignalSDK/OneSignal_XCFramework/OneSignal.xcframework" "OneSignalXCFramework" "framework" "ios-arm64" "ios-arm64_x86_64-maccatalyst" "ios-arm64_x86_64-simulator"
